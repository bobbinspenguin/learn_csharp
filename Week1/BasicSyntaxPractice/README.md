...
This project demonstrates fundamental C# syntax elements including variables, data types, operators, and control flow statements.
...
- Variables and data types (int, long, float, double, decimal, char, string, bool)
- Type conversion (explicit casting, parsing)
