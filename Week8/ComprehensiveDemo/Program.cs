...
Log.Logger = new LoggerConfiguration()
    ...
    .WriteTo.Console()
    .WriteTo.File("logs/comprehensive-demo-.txt", rollingInterval: RollingInterval.Day)
    .CreateLogger();
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "Comprehensive Demo API",
        Version = "v1",
        Description = "A comprehensive e-commerce API demonstrating enterprise-level C# development practices",
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Comprehensive Demo API v1");
...
using (var scope = app.Services.CreateScope())
{
    ...
    try
    {
        ...
        var users = new[]
        {
            new { Email = "admin@demo.com", Password = "Admin123!", Role = "Admin", FirstName = "System", LastName = "Administrator" },
            new { Email = "manager@demo.com", Password = "Manager123!", Role = "Manager", FirstName = "Store", LastName = "Manager" },
            new { Email = "user@demo.com", Password = "User123!", Role = "User", FirstName = "John", LastName = "Customer" }
        };
        ...
        logger.LogInformation("Application started with {ProductCount} products, {OrderCount} orders, and {UserCount} users", 
